...
.new-chat-btn { flex: 1; display: flex; align-items: center; justify-content: center; background: #000000; color: #fff; border: none; border-radius: 8px; padding: 10px 14px; }
